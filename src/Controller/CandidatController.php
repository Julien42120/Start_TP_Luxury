...
class CandidatController extends AbstractController
{
    ...
    /**
     * @Route("admin/{id}", name="candidat_show", methods={"GET"})
     */
     ...
     */
    public function accessDenied(Candidat $candidat):Response
    {
        if ($candidat->profilIsCompleted(true) ) {
            $this->addFlash('success', "Vous n'êtes pas autorisé à accéder à cette page, votre profil doit etre completé a 100% ");
            return $this->redirectToRoute('candidat/edit.html.twig');
        }
        else if ( $candidat->profilIsCompleted(true) ) { 
