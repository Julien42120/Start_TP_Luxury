 ...
 */
final class Version20210607130408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_288A3A4E99DED506 ON job_offer');
        $this->addSql('ALTER TABLE job_offer CHANGE id_client_id client_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer CHANGE client_id id_client_id INT NOT NULL');
        $this->addSql('ALTER TABLE job_offer ADD CONSTRAINT FK_288A3A4E99DED506 FOREIGN KEY (id_client_id) REFERENCES client (id)');
        $this->addSql('CREATE INDEX IDX_288A3A4E99DED506 ON job_offer (id_client_id)');
    }
}
